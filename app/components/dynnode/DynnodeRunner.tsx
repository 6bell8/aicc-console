    ...
    <div className="rounded-lg border bg-white p-4 space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        <div className="space-y-2">
          <div className="text-sm font-semibold">main function 실행 default(fn : main)</div>
          <textarea
        ...
        <div className="space-y-2">
          <div className="text-sm font-semibold">response.body (JSON)</div>
          <textarea
            className="min-h-[260px] w-full rounded-md border p-3 font-mono text-sm"
            value={ctxText}
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        <div className="space-y-2">
          ...
          <textarea className="min-h-[180px] w-full rounded-md border p-3 font-mono text-xs" value={logText} readOnly />
        </div>

        <div className="space-y-2">
          <div className="text-sm font-semibold">result / error</div>
          <textarea
            className="min-h-[180px] w-full rounded-md border p-3 font-mono text-xs"
