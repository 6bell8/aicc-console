...
type ButtonVariant = 'default' | 'outline' | 'secondary' | 'destructive' | 'ghost' | 'hoverGhost' | 'link';
...
const variantClass: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-secondary text-secondary-foreground hover:opacity-90 cursor-pointer',
  destructive: 'bg-destructive text-destructive-foreground hover:opacity-90 cursor-pointer',
  ghost: 'bg-gray-200 text-foreground ursor-pointer dark:bg-gray-800 dark:hover:bg-gray-700',
